					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="col-sm-6">
									<img src="{{('public/frontend/images/iphone2.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{('public/frontend/images/logo1.png')}}"  class="pricing" alt="" />
								</div>
							</div>
							<div class="item">
								<div class="col-sm-6">
								...
								<div class="col-sm-6">
									<img src="{{('public/frontend/images/samsung5.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{('public/frontend/images/logo1.png')}}"  class="pricing" alt="" />
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="{{('public/frontend/images/oppo7.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{('public/frontend/images/logo1.png')}}" class="pricing" alt="" />
								</div>
							</div>
